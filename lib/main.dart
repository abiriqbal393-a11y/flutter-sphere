...
// ==========================================
// २. স্প্ল্যাশ স্ক্রিন (SPLASH SCREEN)
// ==========================================
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    super.initState();
    // ৩ সেকেন্ড পর লগইন স্ক্রিনে নিয়ে যাবে
...
// ==========================================
// ४. মূল নেভিগেশন লেআউট (MAIN LAYOUT)
// ==========================================
...
// ==========================================
// ५. হোম ফিড স্ক্রিন (HOME FEED SCREEN)
// ==========================================
        ...
        child: Column(
          children: [
            ...
            PostCard(
              ...
              timeAgo: '२ ঘণ্টা আগে',
              postText: 'SPHERE অ্যাপে সবাইকে স্বাগতম! এখানে ইউনিক ফিচারে সবকিছু কানেক্টেড থাকবে।',
            ),
          ],
        ),
      ),
...
// ==========================================
// ६. চ্যাটস ইনবক্স স্ক্রিন (CHATS SCREEN)
// ==========================================
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.black,
        elevation: 0,
        title: Text('Chats', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
        actions: [
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  subtitle: Text('SPHERE অ্যাপের চ্যাটস টেস্ট চলছে...', style: TextStyle(color: Colors.grey), maxLines: 1),
...
// ==========================================
// ७. প্রোফাইল স্ক্রিন (PROFILE SCREEN)
// ==========================================
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.black,
        elevation: 0,
        title: Text('প্রোফাইল', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        actions: [
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Column(
                children: [
                  Text('তানভীর আহমেদ', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
                  SizedBox(height: 6),
                  Text('Welcome to my SPHERE world! 🌐', style: TextStyle(color: Colors.grey[400], fontSize: 14)),
                ],
              ),
            ),
            SizedBox(height: 20),
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Details', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                  SizedBox(height: 12),
                  DetailRow(icon: Icons.work_outline, text: 'Works at SPHERE Inc.'),
                  DetailRow(icon: Icons.home_outlined, text: 'Lives in Dhaka, Bangladesh'),
                ],
              ),
            ),
          ],
